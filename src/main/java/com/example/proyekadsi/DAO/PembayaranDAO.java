...
public class PembayaranDAO {
    ...
    public boolean prosesPembayaran(String idJanjiTemu, double jumlah, String metode) {
        ...
        try {
            ...
            // PERBAIKAN: Ganti CURDATE() menjadi CURRENT_DATE (Sintaks PostgreSQL)
            String sqlBayar = "INSERT INTO pembayaran (id_janji_temu, tgl_pembayaran, jumlah, metode_pembayaran, status) " +
                    "VALUES (?, CURRENT_DATE, ?, ?, 'LUNAS')";
